...
- (void)loaddata{
    ...
    for (int i=0;i<20;i++){
        ...
        TestCellPresent *present = [[TestCellPresent alloc]init];
        present.modle2 = model2;
        [self.array addObject:present];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    TestCellPresent *present = [self.array objectAtIndex:indexPath.row];
    [present bindToCell:cell];
    return cell;
}
